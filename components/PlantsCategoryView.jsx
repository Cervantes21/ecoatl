    ...
    <article className="group bg-white rounded-2xl shadow-sm ring-1 ring-slate-200 hover:shadow-md transition p-4 flex flex-col dark:bg-slate-900 dark:ring-slate-800">
      ...
      <div className="mt-4">
        <button
          type="button"
          onClick={() => onOpen(plant)}
          className="inline-flex items-center justify-center rounded-xl px-3 py-2 text-sm font-medium text-white bg-fuchsia-600 hover:bg-fuchsia-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-fuchsia-500"
        >
          Ver detalles
        </button>
      </div>
