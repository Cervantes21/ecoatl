...
/**
 * Props esperadas:
 * - slug: 'estanques' | 'biopool' | 'eco-aqua' (para rutas/ids)
 * - title: string
 * - subtitle?: string
 * - videoBg?: { src: string, poster?: string, overlayOpacity?: number } // opcional
 * - heroImage?: string // fallback si no usas video
 * - tagline?: string
 * - description?: string
 * - bullets?: string[]  // features rápidos
 * - features?: Array<{ title: string, desc: string }>
 * - process?: Array<{ title: string, desc: string }>
 * - gallery?: string[]  // rutas públicas (ej.: /gallery/estanques/xxx.webp)
