// app/products/plants/colocasias/page.js
...
export default function ColocasiasPage() {
  return (
      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-8 pt-6 pb-12">
        ...
        <nav aria-label="Breadcrumb" className="mb-4">
          <ol className="flex items-center gap-1 text-sm text-slate-200">
            ...
            <li>
              <Link href="/products/plants" className="hover:text-white">
                Plantas
              </Link>
            </li>
            <li aria-hidden="true" className="px-1">
            ...
            <li className="text-white">Colocasias</li>
          </ol>
        </nav>
