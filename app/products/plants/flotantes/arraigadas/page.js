// app/products/plants/flotantes/arraigadas/page.js
...
export default function FlotantesArraigadasPage() {
  return (
      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-8 pt-6 pb-12">
        ...
        <nav aria-label="Breadcrumb" className="mb-4">
          <ol className="flex items-center gap-1 text-sm text-slate-200">
            ...
            <li aria-hidden="true" className="px-1"><ChevronRight className="h-4 w-4" /></li>
            <li><Link href="/products/plants/flotantes" className="hover:text-white">Flotantes</Link></li>
            <li aria-hidden="true" className="px-1"><ChevronRight className="h-4 w-4" /></li>
            <li className="text-white">Arraigadas</li>
          </ol>
        </nav>
